...
{
    [Keyless]
    public class DepotBatchReconciliationStockProductWiseDateBetween
    {
		public string ProductCode { get; set; }

		public Nullable<int> OpeningAvailableStock { get; set; }
		public Nullable<int> OpeningPhysicalStock { get; set; }
